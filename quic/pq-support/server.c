...
int handle_quic_connection(SSL *listener)
{
    ...
    // Ensure handshake is fully complete before accessing negotiation data
    ...
    {
        // Complete the handshake if needed
        int handshake_result = SSL_do_handshake(conn);
        ...
        {
            printf("Handshake not yet complete, connection info will be available after first data exchange\n");
        }
    }
...
int main(int argc, char *argv[])
{
    ...
    printf("=== Post-Quantum QUIC Echo Server ===\n\n");
